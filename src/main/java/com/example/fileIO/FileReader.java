...
public class FileReader extends FileReaderMultiDir
{
  ...
  public final transient DefaultOutputPort<StringCount> output  = new DefaultOutputPort<StringCount>();
  ...
  */
  ...
  protected void emit(String tuple)
  {
	  ...
	  StringCount sc = new StringCount(strs[0], Integer.parseInt(strs[1]));  // TODO catch exception
	  output.emit(sc);
  }
